...
@section('conteudo')
    ...
    <div class=" lg:pb-4">
      ...
      <div class="px-4  text-green-400 text-base md:text-lg font-extrabold uppercase tracking-wide mb-8 ">Resultado da Pesquisa</div>
        
        <div class="p-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4  text-sm text-gray-700">
            
        @foreach ($pesquisa_url as $filme)

        @if (isset($filme['vote_average']) && $filme['vote_average'] > 6.6)
